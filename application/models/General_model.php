...
class General_model extends CI_Model
{
  ...
  {
    $data['comment'] = $this->db->query('select id, comment, fullname, date_order  from view_detail_order where id_product='.$id.' and comment is not null order by id desc limit 10')->result();
