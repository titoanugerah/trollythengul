        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-12">
              ...
              <input type="text" class="form-control" placeholder="Masukan nama produk anda" name="name" value="<?php echo $product->product; ?>" disabled>
            </div>

            <div class="form-group col-md-12">
              <label>Keterangan Produk</label>
              <textarea type="text" class="form-control" placeholder="Masukan keterangan produk anda" name="description" value=""  cols="180" rows="5" disabled><?php echo $product->description; ?></textarea>
            </div>
            ...
            <div class="form-group col-md-4">
              ...
              <input type="number" class="form-control"  name="price" value="<?php echo $product->price; ?>" disabled>
            </div>
