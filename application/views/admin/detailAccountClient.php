            ...
            <table id="multi-filter-select" class="display table table-striped table-hover" cellspacing="0" width="100%">
              ...
              <tbody>
                <?php $i=1;foreach ($shipment as $item): ?>
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $item->shipment_street.', '.$item->shipment_city.', '.$item->shipment_province.'. Kode Pos '.$item->shipment_postal_code.' ('.$item->shipment_info.')'; ?></td>
                    <td><?php echo $item->shipment_count; ?></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
