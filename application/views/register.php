...
<!-- Mirrored from themekita.com/demo-atlantis-bootstrap/livepreview/examples/demo1/login2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Aug 2019 11:06:50 GMT -->
<head>
	...
	<script>
		WebFont.load({
			...
			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"], urls: ['<?php echo base_url('./assets/template/newlogin'); ?>/assets/css/fonts.min.css']},
			active: function() {
...
<!-- Mirrored from themekita.com/demo-atlantis-bootstrap/livepreview/examples/demo1/login2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Aug 2019 11:06:52 GMT -->
</html>
